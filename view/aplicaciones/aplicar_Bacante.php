...
<html lang="en">
    ...
    <body class="d-flex flex-column h-100">
            ...
            <section class="py-5">
                <div class="container px-5 my-5">
                    ...
                    <div class="container mt-5">
                        <?php $tablaAplicaciones->mostrarAplicacionesPrincipal(); ?>
                    </div>
                </div>
            </section>
        </main>
        ...
        <script>
            // Script para pasar datos al modal de aplicación
            $('#aplicarModal').on('show.bs.modal', function (event) {
                var button = $(event.relatedTarget);
                var id = button.data('id');
                var puesto = button.data('puesto');
                var modal = $(this);
                modal.find('#empleo_id').val(id);
                modal.find('.modal-title').text('Aplicar a ' + puesto);
            });
        </script>
    </body>
</html>
